...
Disable a BIG-IP physical interface
    ...
    log to console                  Disabling interface ${TARGET_INTERFACE}
    create session                  modify-net-interface-disable        https://${IPV4_MGMT}    verify=False
    ...
    ${api_response}                 Patch Request   modify-net-interface-disable    /mgmt/tm/net/interface/${TARGET_INTERFACE}    headers=${api_headers}  json=${api_payload}
...
Verify disabled state of BIG-IP physical interface
    ...
    log to console                  Verifying the Disabling interface ${TARGET_INTERFACE}
...
Verify down state of BIG-IP physical interface
    ...
    log to console                  Verifying the Down state of interface ${TARGET_INTERFACE}
