...
Create All VLANs on the BIG-IP
    ...
    \   Create Session                  bigip-create-net-vlan            https://${IPV4_MGMT}        verify=False
    \   &{api_headers}                  Create Dictionary               Content-type=application/json       X-F5-Auth-Token=${api_auth_token}
    ...
    \   ${api_response}                 Post Request                   bigip-create-net-vlan    /mgmt/tm/net/vlan        headers=${api_headers}      json=${api_payload}
    \   Should Be Equal As Strings      ${api_response.status_code}     200
