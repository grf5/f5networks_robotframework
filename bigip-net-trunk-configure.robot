...
Configure BIG-IP trunk object
    ...
    ${api_payload}                  set variable        ${trunk_object_payload}
    ...
    ${trunk_parameters_list}        get from dictionary             ${api_response_dict}    items
    ${trunk_parameters_dict}        get from list                   ${trunk_parameters_list}    0
    dictionary should contain sub dictionary  ${trunk_parameters_dict}      ${trunk_object_payload}
