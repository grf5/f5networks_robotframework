...
Verify Trunk Drop Counters on BIG-IP
    ...
    create session                  show-net-trunk-collisions       https://${IPV4_MGMT}        verify=False
    &{api_headers}                  Create Dictionary               Content-type=application/json       X-F5-Auth-Token=${api_auth_token}
    ${api_response}                 get request                     show-net-trunk-collisions   /mgmt/tm/net/trunk/${trunk_object_name}/stats   headers=${api_headers}
